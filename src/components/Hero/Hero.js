...
const Hero = (props) => (
  <Section row nopadding>
    <LeftSection>
      ...
      <img src="../images/profile.png" alt="Profile" /> <br /><br />
      ...
      <Button onClick={() => window.location = 'https://drive.google.com/file/d/1qVfbZd19g1N1j-2VCOlgqDBsoSibC2kb/view?usp=sharing'} >Learn More</Button>
    </LeftSection>
  </Section>
);
